...
// KvaserDILTester.cpp : Defines the initialization routines for the DLL.
//
...
{
	CString omCurrExe;
    omCurrExe.Format("%s\\Kvaser Controller Configuration.exe", g_strPath);
