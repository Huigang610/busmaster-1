...
Modifications   :   -
************************************************************************************/
void CMsgBufVSE::clearMessageBuffer(void)
{
...
int CMsgBufVSE::getMessageCount(void) const
{
    return m_nMsgCount;
}

HANDLE CMsgBufVSE::getNotifyEvent(void) const
{
...
int CMsgBufVSE::setBufferSize(int& nSize)
{
    int nResult = CALL_SUCCESS;
