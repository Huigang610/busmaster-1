...
struct sNODEINFO
{
    ...
    BOOL m_bEventHandlersEnabled;               // Event Handlers Enabled = 1,Disabled = 0.
...
public:
    ...
    void vSetEnableAllSimSysEventHandlers(CString& omStrSimSysName , BOOL bIsEnabled);
    BOOL bReturnAllEventHandlersStatus(CString& omStrSimSysName);
    ...
    void vSetEnableNodeEventHandlers(CString omStrSimSysName ,
                                     CString& omStrNodeName , BOOL bIsEnabled);
    BOOL bReturnNodeEventHandlersStatus(CString& omStrSimSysName ,
                                        CString& omStrNodeName);
