...
CSigWatchAddDelDlg::CSigWatchAddDelDlg(CWnd* pParent, SignalWatchListMainEntries* psMainFrameSignalWatchList)
    ...
    if (m_podTempCallerList != NULL)
    {
        ...
        if ( pos != NULL)
        {
            ...
            while (SubPos != NULL)
            {
                ...
                m_omListCtrlSignal.InsertItem(unCountItem++, sSubEntry.subEntryName);
            }
