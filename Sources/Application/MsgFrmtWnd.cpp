...
CString CMsgFrmtWnd::strGetMsgNameOrCode(UINT nMsgCode)
{
    ...
    if (NULL != m_ppMsgDB)
    {
        if ( !(*m_ppMsgDB)->bMessageNameFromMsgCode(nMsgCode, omName))
        {
            ...
            {
                omName.Format("%d", nMsgCode);
            }
            else
            {
                omName.Format("%X", nMsgCode);
                omName = "0x" + omName;
            }
        }
    }
...
void CMsgFrmtWnd::vSetDefaultHeaders()
{
    ...
    switch (m_eBusType)
    {
        case CAN:
        {
            ...
            somArrColTitle[sHdrCtrlPos.m_byTimePos]     += "              ";
            ...
            somArrColTitle[sHdrCtrlPos.m_byDataPos]     += "                                     ";
        ...
        case J1939:
        {
            ...
            somArrColTitle[sHdrCtrlPos.m_byDestPos]     += "       ";
